...
`+p.vertexShader,p.vertexShader=p.vertexShader.replace("#include <begin_vertex>",`
            ...
            `),p.vertexShader=p.vertexShader.replace("gl_PointSize = size;","gl_PointSize = s;"),h.userData.shader=p}}animate(h){this.mesh.rotation.set(0,h*.2,0),this.material.userData.shader&&(this.material.userData.shader.uniforms.time.value=h)}}return s(),u(),()=>{cancelAnimationFrame(a),window.removeEventListener("resize",l),e.removeChild(r.domElement)}},[]),k.jsx("div",{className:"AnimationAiMdiv",ref:t,style:{width:"100%",maxHeight:"400px",margin:"0 auto",display:"flex",justifyContent:"center",alignItems:"center"}})},jv="data:image/svg+xml,%3csvg%20width='15'%20height='15'%20viewBox='0%200%2015%2015'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M12.3669%206.6849L3.25236%201.48253C3.09872%201.39635%202.92249%201.35895%202.74709%201.3753C2.57169%201.39165%202.40542%201.46098%202.27036%201.57408C2.1353%201.68718%202.03785%201.8387%201.99095%202.0085C1.94404%202.1783%201.94992%202.35836%202.00778%202.52474L3.68964%207.43305C3.68942%207.43486%203.68942%207.43668%203.68964%207.43848C3.68933%207.44027%203.68933%207.44211%203.68964%207.4439L2.00778%2012.3631C1.96144%2012.494%201.94717%2012.634%201.96618%2012.7716C1.98518%2012.9091%202.0369%2013.0401%202.11699%2013.1535C2.19708%2013.2669%202.30322%2013.3595%202.42648%2013.4234C2.54974%2013.4873%202.68653%2013.5207%202.82538%2013.5208C2.97603%2013.5205%203.12402%2013.4812%203.25507%2013.4069L12.3648%208.19586C12.4991%208.12058%2012.6111%208.01091%2012.6891%207.8781C12.7671%207.74528%2012.8083%207.59411%2012.8086%207.44009C12.8089%207.28606%2012.7682%207.13474%2012.6906%207.00165C12.6131%206.86855%2012.5016%206.75848%2012.3675%206.68273L12.3669%206.6849ZM2.82538%2012.6528V12.6479L4.46058%207.87847H7.59969C7.7148%207.87847%207.82519%207.83275%207.90659%207.75135C7.98799%207.66995%208.03371%207.55956%208.03371%207.44445C8.03371%207.32933%207.98799%207.21894%207.90659%207.13754C7.82519%207.05615%207.7148%207.01042%207.59969%207.01042H4.46492L2.82864%202.24262L2.82538%202.23611L11.94%207.43522L2.82538%2012.6528Z'%20fill='%2301CAD9'/%3e%3c/svg%3e";function DL(){const[t,e]=te.useState(""),[n,i]=te.useState([]),[r,o]=te.useState(!1),{loadingAi:a,askQuestion:s}=dC(p=>({loadingAi:p.loadingAi,askQuestion:p.askQuestion})),l=async()=>{if(o(!0),!a&&t.trim()!==""){i([...n,{text:t,isUser:!0}]),e("");const p=await s(t);i([...n,{text:t,isUser:!0},{text:`AI: ${p}`,isUser:!1}])}};function u(p){e(p),l()}const c=p=>{p.key==="Enter"&&l()},{StateBurger:f,ShowBurger:h}=vx(p=>({StateBurger:p.StateBurger,ShowBurger:p.ShowBurger}));return k.jsxs(k.Fragment,{children:[k.jsxs("div",{className:"AiContent",children:[k.jsx("div",{style:{height:"80px",width:"100%"}}),k.jsx(xx,{title:"NOROV AI"}),k.jsxs("div",{className:"AiContent__body",children:[k.jsx("div",{className:`AnimationAi ${r?"filterB":""}`,children:k.jsx(PL,{})}),k.jsx("div",{id:"chat-history",children:n.map((p,g)=>k.jsx(k.Fragment,{children:k.jsx("div",{className:`message ${p.isUser?"user-message":"ai-message"}`,children:p.text},g)}))}),r?"":k.jsxs("div",{className:"Padskazka",children:[k.jsx("div",{onClick:()=>u("wdafaw fawffafwfa"),children:k.jsx("p",{children:"wdafaw fawffafwfa"})}),k.jsx("div",{onClick:()=>u("wdafaw fawffafwfa"),children:k.jsx("p",{children:"wdafaw fawffafwfa"})}),k.jsx("div",{onClick:()=>u("wdafaw fawffafwfa"),children:k.jsx("p",{children:"wdafaw fawffafwfa"})}),k.jsx("div",{onClick:()=>u("wdafaw fawffafwfa"),children:k.jsx("p",{children:"wdafaw fawffafwfa"})})]})]}),k.jsxs("div",{className:"AiContent__text",children:[k.jsx("input",{type:"text",id:"input-question",value:t,onChange:p=>e(p.target.value),onKeyDown:c,placeholder:"Введите свой вопрос...",autoComplete:"off"}),a?k.jsx("button",{id:"btn-send",className:"filterB",children:k.jsx("img",{src:jv,alt:"iconSend"})}):k.jsx("button",{id:"btn-send",onClick:l,children:k.jsx("img",{src:jv,alt:"iconSend"})})]}),k.jsx(yx,{title:"NOROV AI"})]}),k.jsxs("div",{className:"BurgerMenu",style:{left:f?0:"-100%"},children:[k.jsx("div",{className:"Bmenu"}),k.jsx("div",{className:"Fon",onClick:()=>{h(!1)}})]})]})}function LL(){return k.jsx(k.Fragment,{children:k.jsxs(yw,{children:[k.jsx(wd,{path:"/",element:k.jsx(_C,{})}),k.jsx(wd,{path:"/content",element:k.jsx(DL,{})})]})})}function NL(){return k.jsx(k.Fragment,{children:k.jsx(LL,{})})}function IL(){return k.jsx(k.Fragment,{children:k.jsx(NL,{})})}Pf.createRoot(document.getElementById("root")).render(k.jsx(Aw,{children:k.jsx(IL,{})}));
